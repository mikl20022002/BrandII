...
UNIFY_PROFILE_STEP1 = 'Ответьте на следующие вопросы, что бы мы могли добавить больше уникальности вашим постам'
UNIFY_PROFILE_QUE1 = 'Как тебя зовут?'
UNIFY_PROFILE_QUE2 = 'Напиши свой пол'
UNIFY_PROFILE_QUE3 = 'Сколько тебе лет? '
UNIFY_PROFILE_QUE4 = 'Какова твоя профессия, специальность? Кем вы работаете? На кого учитесь?'
UNIFY_PROFILE_QUE5 = 'Чем ты увлекаешься? Какие хобби увлечения или интересы у тебя есть? Чем ты горишь? '
UNIFY_PROFILE_QUE6 = 'Используешь ли ты какие-то ключевые слова или определенные хештеги для своих постов? Если да, то какие?'
UNIFY_PROFILE_QUE7 = 'Какова твоя цель или миссия? Что ты стремишься достичь своими действиями и контентом?'
UNIFY_PROFILE_QUE8 = 'Отправь свои самые часто используемые эмодзи, которые ты обычно добавляешь к постам.'
UNIFY_PROFILE_FINISH = 'Ответы сохранены, теперь они будут влиять на генерируемые посты.'
...
UNIFY_TEXT_PROMPT_1 = 'Перепиши текст так, будто он написан человеком со следующим описанием: '

DELETE_ML_PRESENCE_PROMPT = 'Перепиши текст так, что бы он выглядит как текст, написанный живым человеком.' \
                            ' Удали все странности, которые могли быть добавлены неиросетью. Текст: '